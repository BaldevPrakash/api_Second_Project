...
const MongoUrl= "mongodb+srv://Baladev:Baladev1902@cluster0.adn57.mongodb.net/ZomatoCloner?retryWrites=true&w=majority"
dotenv.config()
...
const city = [
    ...
    {
      "location_id": 15,
      "location_name": "Saheed Nagar, Bhubaneswar",
      "state_id": 7,
      "state": "Odisha",
      "country_name": "India"
    }
...
//get
app.get('/',(req,res) => {
    res.send("<center><h1> Welcome to My live api</h1></center>")
})
